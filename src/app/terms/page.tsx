  ...
  return (
    <div className="min-h-screen bg-gray-100 py-10">
      <div className="max-w-4xl mx-auto bg-white p-8 shadow-md rounded-lg">
        ...
        <p className="mb-4">
          Atolia uygulamasıyla ilgili herhangi bir sorunuz veya sorununuz varsa, lütfen <a href="mailto:support@atolia.com" className="text-blue-500">support@atolia.com</a> adresine e-posta göndererek bizimle iletişime geçin.
        </p>
